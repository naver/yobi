...
class EmailHandler {
    /**
     * Fetch new emails from the given IMAP folder and process them.
     *
     * @param folder
     * @throws MessagingException
     */
    static void handleNewMessages(IMAPFolder folder) throws MessagingException {
        Long lastUIDValidity = Property.getLong(Property.Name.EMAIL_RECEIVER_LAST_UID_VALIDITY);
        Long lastSeenUID = Property.getLong(Property.Name.EMAIL_RECEIVER_LAST_SEEN_UID);
        ...
        Property.set(Property.Name.EMAIL_RECEIVER_LAST_UID_VALIDITY, uidValidity);
    }

    /**
     * Process the given emails.
     *
     * @param folder
     * @param messages
     */
