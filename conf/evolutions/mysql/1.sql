...
create table assignee (
  ...
  user_id                   bigint,
  project_id                bigint,
  constraint pk_assignee primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table comment_thread (
  ...
  constraint pk_comment_thread primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table commit_comment (
  ...
  constraint pk_commit_comment primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table email (
  ...
  token                     varchar(255),
  constraint pk_email primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table issue (
  ...
  constraint pk_issue primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table issue_comment (
  ...
  author_name               varchar(255),
  issue_id                  bigint,
  constraint pk_issue_comment primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table issue_event (
  ...
  constraint pk_issue_event primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table issue_label (
  ...
  name                      varchar(255),
  project_id                bigint,
  constraint pk_issue_label primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table issue_label_category (
  ...
  constraint pk_issue_label_category primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table label (
  ...
  constraint pk_label primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table mention (
  ...
  constraint pk_mention primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table milestone (
  ...
  constraint pk_milestone primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table notification_event (
  ...
  constraint pk_notification_event primary key (id)) ROW_FORMAT=COMPRESSED
;

create table notification_mail (
  id                        bigint auto_increment not null,
  notification_event_id     bigint,
  constraint pk_notification_mail primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table organization (
  ...
  created                   datetime,
  descr                     varchar(255),
  constraint pk_organization primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table organization_user (
  ...
  role_id                   bigint,
  constraint pk_organization_user primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table original_email (
  ...
  constraint pk_original_email primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table posting (
  ...
  constraint pk_posting primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table posting_comment (
  ...
  author_name               varchar(255),
  posting_id                bigint,
  constraint pk_posting_comment primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table project (
  ...
  constraint pk_project primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table project_menu_setting (
  ...
  constraint pk_project_menu_setting primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table project_transfer (
  ...
  constraint pk_project_transfer primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table project_user (
  ...
  project_id                bigint,
  role_id                   bigint,
  constraint pk_project_user primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table project_visitation (
  ...
  constraint pk_project_visitation primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table property (
  ...
  constraint pk_property primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table pull_request (
  ...
  constraint pk_pull_request primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table pull_request_commit (
  ...
  constraint pk_pull_request_commit primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table pull_request_event (
  ...
  constraint pk_pull_request_event primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table project_pushed_branch (
  ...
  name                      varchar(255),
  project_id                bigint,
  constraint pk_project_pushed_branch primary key (id)) ROW_FORMAT=COMPRESSED
;

create table recently_visited_projects (
  id                        bigint auto_increment not null,
  user_id                   bigint,
  constraint pk_recently_visited_projects primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table review_comment (
  ...
  author_name               varchar(255),
  thread_id                 bigint,
  constraint pk_review_comment primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table role (
  ...
  constraint pk_role primary key (id)) ROW_FORMAT=COMPRESSED
;

create table site_admin (
  id                        bigint auto_increment not null,
  admin_id                  bigint,
  constraint pk_site_admin primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table unwatch (
  ...
  constraint pk_unwatch primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table n4user (
  ...
  constraint pk_n4user primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table user_project_notification (
  ...
  constraint pk_user_project_notification primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table watch (
  ...
  constraint pk_watch primary key (id)) ROW_FORMAT=COMPRESSED
;
...
create table comment_thread_n4user (
  ...
  constraint pk_comment_thread_n4user primary key (comment_thread_id, n4user_id)) ROW_FORMAT=COMPRESSED
;

create table issue_issue_label (
  issue_id                       bigint not null,
  issue_label_id                 bigint not null,
  constraint pk_issue_issue_label primary key (issue_id, issue_label_id)) ROW_FORMAT=COMPRESSED
;

create table issue_voter (
  issue_id                       bigint not null,
  user_id                        bigint not null,
  constraint pk_issue_voter primary key (issue_id, user_id)) ROW_FORMAT=COMPRESSED
;

create table issue_comment_voter (
  issue_comment_id               bigint not null,
  user_id                        bigint not null,
  constraint pk_issue_comment_voter primary key (issue_comment_id, user_id)) ROW_FORMAT=COMPRESSED
;

create table notification_event_n4user (
  notification_event_id          bigint not null,
  n4user_id                      bigint not null,
  constraint pk_notification_event_n4user primary key (notification_event_id, n4user_id)) ROW_FORMAT=COMPRESSED
;

create table project_label (
  project_id                     bigint not null,
  label_id                       bigint not null,
  constraint pk_project_label primary key (project_id, label_id)) ROW_FORMAT=COMPRESSED
;

create table pull_request_reviewers (
  pull_request_id                bigint not null,
  user_id                        bigint not null,
  constraint pk_pull_request_reviewers primary key (pull_request_id, user_id)) ROW_FORMAT=COMPRESSED
;

create table user_enrolled_project (
  user_id                        bigint not null,
  project_id                     bigint not null,
  constraint pk_user_enrolled_project primary key (user_id, project_id)) ROW_FORMAT=COMPRESSED
;

create table user_enrolled_organization (
  user_id                        bigint not null,
  organization_id                bigint not null,
  constraint pk_user_enrolled_organization primary key (user_id, organization_id)) ROW_FORMAT=COMPRESSED
;
